        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-12">
                <div class="about-image-wrap custom-border-radius-start">
                    <img src="{{ asset('images/professional-asian-businesswoman-gray-blazer.jpg') }}" class="about-image custom-border-start img-fluid" class="about-image custom-border-radius-start img-fluid" alt="">
            ...
            <div class="col-lg-3 col-12">
                <div class="instagram-block">
                    <img src="{{ asset('images/horizontal-shot-happy-mixed-race-females.jpg') }}" class="about-image custom-border-start img-fluid" class="about-image custom-border-radius-end img-fluid" alt="">
            ...
            <div class="col-lg-12 col-12">
                <div class="job-thumb d-flex">
                    <div class="job-image-wrap bg-white shadow-lg">
                        <img src="{{ asset('images/logos/google.png') }}" class="about-image custom-border-start img-fluid" class="job-image img-fluid" alt="">
                    </div>
                ...
                <div class="job-thumb d-flex">
                    <div class="job-image-wrap bg-white shadow-lg">
                        <img src="{{ asset('images/logos/apple.png') }}" class="about-image custom-border-start img-fluid" class="job-image img-fluid" alt="">
                    </div>
                ...
                <div class="job-thumb d-flex">
                    <div class="job-image-wrap bg-white shadow-lg">
                        <img src="{{ asset('images/logos/meta.png') }}" class="about-image custom-border-start img-fluid" class="job-image img-fluid" alt="">
                    </div>
                ...
                <div class="job-thumb d-flex">
                    <div class="job-image-wrap bg-white shadow-lg">
                        <img src="{{ asset('images/logos/slack.png') }}" class="about-image custom-border-start img-fluid" class="job-image img-fluid" alt="">
                    </div>
                ...
                <div class="job-thumb d-flex">
                    <div class="job-image-wrap bg-white shadow-lg">
                        <img src="{{ asset('images/logos/creative-market.png') }}" class="about-image custom-border-start img-fluid" class="job-image img-fluid" alt="">
                    </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-12">
                <div class="video-thumb">
                    <img src="{{ asset('images/people-working-as-team-company.jpg') }}" class="about-image custom-border-start img-fluid about-image custom-border-radius-end img-fluid" alt="">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4 col-md-6 col-12">
                <div class="job-thumb job-thumb-box">
                    <div class="job-image-box-wrap">
                        <a href="{{ route("job_dimgetails") }}">
                            <img src="{{ asset('images/jobs/it-professional-works-startup-project.jpg') }}" class="about-image custom-border-start img-fluid job-image img-fluid" alt="">
                    ...
                    <div class="job-body">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="job-image-wrap d-flex align-items-center bg-white shadow-lg mt-2 mb-4">
                                <img src="{{ asset('images/logos/salesforce.png') }}" class="about-image custom-border-start img-fluid job-image me-3" alt="">
                ...
                <div class="job-thumb job-thumb-box">
                    <div class="job-image-box-wrap">
                        <a href="job-details.html">
                            <img src="{{ asset('images/jobs/marketing-assistant.jpg') }}" class="about-image custom-border-start img-fluid job-image" alt="marketing assistant">
                    ...
                    <div class="job-body">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="job-image-wrap d-flex align-items-center bg-white shadow-lg mt-2 mb-4">
                                <img src="{{ asset('images/logos/spotify.png') }}" class="about-image custom-border-start img-fluid job-image me-3" alt="">
            ...
            <div class="col-lg-4 col-md-6 col-12">
                <div class="job-thumb job-thumb-box">
                    <div class="job-image-box-wrap">
                        <a href="job-details.html">
                            <img src="images/jobs/pretty-blogger-posing-cozy-apartment.jpg" class="about-image custom-border-start img-fluid" class="job-image img-fluid" alt="">
                        </a>
                    ...
                    <div class="job-body">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="job-image-wrap d-flex align-items-center bg-white shadow-lg mt-2 mb-4">
                                <img src="images/logos/yelp.png" class="about-image custom-border-start img-fluid" class="job-image me-3 img-fluid" alt="">
            ...
            <div class="col-lg-4 col-md-6 col-12">
                <div class="job-thumb job-thumb-box">
                    <div class="job-image-box-wrap">
                        <a href="job-details.html">
                            <img src="images/jobs/paper-analysis.jpg" class="about-image custom-border-start img-fluid" class="job-image img-fluid" alt="">
                        </a>
                    ...
                    <div class="job-body">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="job-image-wrap d-flex align-items-center bg-white shadow-lg mt-2 mb-4">
                                <img src="images/logos/paypal.png" class="about-image custom-border-start img-fluid" class="job-image me-3 img-fluid" alt="">
            ...
            <div class="col-lg-4 col-md-6 col-12">
                <div class="job-thumb job-thumb-box">
                    <div class="job-image-box-wrap">
                        <a href="job-details.html">
                            <img src="images/jobs/logo-designer-working-computer-desktop.jpg" class="about-image custom-border-start img-fluid" class="job-image img-fluid" alt="">
                        </a>
                    ...
                    <div class="job-body">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="job-image-wrap d-flex align-items-center bg-white shadow-lg mt-2 mb-4">
                                <img src="images/logos/envato.png" class="about-image custom-border-start img-fluid" class="job-image me-3 img-fluid" alt="">
            ...
            <div class="col-lg-12 col-12">
                ...
                <div class="owl-carousel owl-theme reviews-carousel">
                    ...
                    <div class="reviews-thumb">
                        ...
                        <div class="reviews-info d-flex align-items-center">
                            <img src="images/avatar/portrait-beautiful-young-woman.jpg" class="about-image custom-border-start img-fluid" class="avatar-image img-fluid" alt="">
                    ...
                    <div class="reviews-thumb">
                        <div class="reviews-info d-flex align-items-center">
                            <img src="images/avatar/university-study-abroad-lifestyle-concept.jpg" class="about-image custom-border-start img-fluid" class="avatar-image img-fluid" alt="">
