    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-12">
                <img src="{{ asset('images/4557388.png') }}" class="about-image custom-border-start img-fluid" alt="Job Search">
            </div>
        </div>
    </div>
</section>
                ...
                <div class="job-thumb job-thumb-box">
                    <div class="job-image-box-wrap">
                        <a href="{{ route('job_details', $job->id) }}">
                            <img src="{{ asset($job->image) }}" class="about-image custom-border-start img-fluid" alt="{{ $job->title }}">
                        </a>
                        <div class="job-image-box-wrap-info d-flex align-items-center">
                            <p class="mb-0">
                                <a href="{{ route('job_listings') }}" class="badge badge-level">{{ $job->level }}</a>
                            </p>
                            <p class="mb-0">
                                <a href="{{ route('job_listings') }}" class="badge">{{ $job->type }}</a>
                            </p>
                        </div>
                    </div>
                    <div class="job-body">
                        <h4 class="job-title">
                            <a href="{{ route('job_details', $job->id) }}" class="job-title-link">{{ $job->title }}</a>
                        </h4>
                        <div class="d-flex align-items-center">
                            <div class="job-image-wrap d-flex align-items-center bg-white shadow-lg mt-2 mb-4">
                                <img src="{{ asset($job->company->logo) }}" class="about-image custom-border-start img-fluid" alt="{{ $job->company->name }}">
                        ...
                        <div class="d-flex align-items-center border-top pt-3">
                            ...
                            <a href="{{ route('job_details', $job->id) }}" class="custom-btn btn ms-auto">Apply now</a>
                        </div>
                    </div>
                </div>
            </div>
