    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-6 col-12">
                <img src="images/4557388.png" class="about-image custom-border-start img-fluid" class="hero-image img-fluid" alt="">
            </div>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-4 col-md-6 col-12">
                <div class="job-thumb job-thumb-box">
                    <div class="job-image-box-wrap">
                        <a href="{{ route("job_details") }}">
                            <img src="images/jobs/portrait-woman-customer-service-worker.jpg" class="about-image custom-border-start img-fluid" class="job-image img-fluid" alt="">
                        </a>
                    ...
                    <div class="job-body">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="job-image-wrap d-flex align-items-center bg-white shadow-lg mt-2 mb-4">
                                <img src="images/logos/microsoft.png" class="about-image custom-border-start img-fluid" class="job-image me-3 img-fluid" alt="">
            ...
            <div class="col-lg-4 col-md-6 col-12">
                <div class="job-thumb job-thumb-box">
                    <div class="job-image-box-wrap">
                        <a href="{{ route("job_details") }}">
                            <img src="images/jobs/young-woman-teaching-english-lessons.jpg" class="about-image custom-border-start img-fluid" class="job-image img-fluid" alt="">
                        </a>
                    ...
                    <div class="job-body">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="job-image-wrap d-flex align-items-center bg-white shadow-lg mt-2 mb-4">
                                <img src="images/logos/dropbox.png" class="about-image custom-border-start img-fluid" class="job-image me-3 img-fluid" alt="">
             ...
             <div class="col-lg-4 col-md-6 col-12">
                <div class="job-thumb job-thumb-box">
                    <div class="job-image-box-wrap">
                        <a href="{{ route("job_details") }}">
                            <img src="images/jobs/sound-engineer-working-studio-with-equipment.jpg" class="about-image custom-border-start img-fluid" class="job-image img-fluid" alt="">
                        </a>
                    ...
                    <div class="job-body">
                        ...
                        <div class="d-flex align-items-center">
                            <div class="job-image-wrap d-flex align-items-center bg-white shadow-lg mt-2 mb-4">
                                <img src="images/logos/soundcloud.png" class="about-image custom-border-start img-fluid" class="job-image me-3 img-fluid" alt="">
